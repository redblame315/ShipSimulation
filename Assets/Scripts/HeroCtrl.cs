...
public class HeroCtrl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            if (t.name == "CC_Base_Hip") // Enter your root bone name here
                rootB = t;
    ...
    void OnAnimatorMove()
    {
        ...
        {            
            ...
            if (grounded && (h > 0 || v > 0))
                gameManager.AddEnergy(-1 * moveEnergy * Time.deltaTime);
        }
    }
    //=================================================================================================================o
    ...
    void CheckClimb()
    {
        ...
        if (isClimb)
        {
            gameManager.AddEnergy(-1 * climbEnergy);
            Debug.Log("climbEnergy");
        }
    ...
    void EdgeClimb()
    {
        ...
        if (!st.IsTag("Oh") && !a.IsInTransition(0)) // not if overhanging
        {
            ...
            if (h != 0.0f)
            {
                ...
                gameManager.AddEnergy(-1 * climbEnergy * Time.deltaTime);
            }
