...
public class InvEquipment : MonoBehaviour
{
	...
	{		
		...
		if (slot != InvBaseItem.Slot.None)
		{
			...
			/*if (item != null)
			{
				...
				GameManager.instance.playerInfo.itemState[index] = 1;
	...
	public void Equip(int index)
	{
		...
		if (item != null)
		{
			...
			gi.quality = (InvGameItem.Quality)Random.Range(1, 1);
    ...
    {
		Replace(InvBaseItem.Slot.Bracers, null);
		Replace(InvBaseItem.Slot.Shoulders, null);
	}
}